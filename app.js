...
// Calculate remaining days for fee payment
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-xl shadow-md p-6 border-2 border-red-200">
                    ...
                    <div class="mt-3 mb-3 p-3 bg-red-50 rounded-lg border border-red-300">
                        <p class="text-xs text-red-600 font-semibold">Due Date</p>
                        <p class="text-sm font-bold text-gray-800">${formatDate(feesData.dueDate)}</p>
                        <p class="text-xs text-red-600 mt-1">${getRemainingDays(feesData.dueDate)} days remaining</p>
                    </div>
                    <button class="mt-3 w-full bg-red-600 text-white py-2 rounded-lg hover:bg-red-700 transition-all font-medium">
                        Pay Now
                    </button>
                </div>
            </div>
